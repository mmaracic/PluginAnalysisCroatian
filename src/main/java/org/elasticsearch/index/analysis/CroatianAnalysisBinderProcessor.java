...
//    }
    ...
    public void processTokenizers(TokenizersBindings tokenizersBindings) {
        tokenizersBindings.processTokenizer("croatian_number_tokenizer", NumberTokenizerFactory.class);
        tokenizersBindings.processTokenizer("croatian_backfront_tokenizer", BackFrontTokenizerFactory.class);
    }
